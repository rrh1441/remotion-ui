      ...
      {processedSegments.map((segment, index) => {
        ...
        return (
          <Sequence
            ...
            durationInFrames={segment.effectiveDuration || undefined}
          >
            <AudioSegmentPlayer
              segment={segment}
...
interface AudioSegmentPlayerProps {
  ...
  prevSegment?: AudioSegment & { effectiveDuration?: number } | undefined;
  nextSegment?: AudioSegment & { effectiveDuration?: number } | undefined;
}
...
const AudioSegmentPlayer: React.FC<AudioSegmentPlayerProps> = ({
  ...
  return (
    <Audio
      ...
      {...(segment.trim?.start !== undefined && { startFrom: segment.trim.start })}
      {...(segment.trim?.end !== undefined && { endAt: segment.trim.end })}
    />
  );
};
